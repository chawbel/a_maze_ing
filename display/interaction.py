...
THEMES = [
    {
        "C_BG": 0x000000, "C_WALL": 0xFFFFFF, "C_ENTRY": 0x00CC44,
        "C_EXIT": 0xDD2222, "C_PATH": 0xFFDD00, "C_PATH_BORDER": 0xFF8800,
        "C_42": 0x3355AA,
    },
    {
        "C_BG": 0x0A1628, "C_WALL": 0x5BAAF5, "C_ENTRY": 0x44FF88,
        "C_EXIT": 0xFF4444, "C_PATH": 0xFFEE55, "C_PATH_BORDER": 0xFFAA00,
        "C_42": 0x2244AA,
    },
    {
        "C_BG": 0x0D1F0D, "C_WALL": 0x44BB55, "C_ENTRY": 0xAAFF44,
        "C_EXIT": 0xFF4422, "C_PATH": 0xFFFF88, "C_PATH_BORDER": 0xBBDD00,
        "C_42": 0x225522,
    },
    {
        "C_BG": 0x120800, "C_WALL": 0xFF6600, "C_ENTRY": 0x88FF44,
        "C_EXIT": 0xFF2244, "C_PATH": 0xFFDD88, "C_PATH_BORDER": 0xFF9900,
        "C_42": 0x662200,
    },
    {
        "C_BG": 0x050A14, "C_WALL": 0x88DDFF, "C_ENTRY": 0x44FFCC,
        "C_EXIT": 0xFF4466, "C_PATH": 0xCCEEFF, "C_PATH_BORDER": 0x44AAFF,
        "C_42": 0x1133AA,
    },
]
...
def _directions_to_cells(start: tuple[int,int],
                          directions: list[str]) -> list[tuple[int,int]]:
...
class AppState:
    ...
    @property
    def active_theme(self): return THEMES[self.theme_index]

    @property
    def theme_name(self): return THEME_NAMES[self.theme_index]
